  ...
  return (
    ...
    >
      {session ? (
        ...
        <div className="flex items-center justify-between gap-3 rounded-xl border border-white/10 bg-black/20 p-2">
          <p className="text-xs text-slate-400">Connect your Mind to direct the film.</p>
            <button
              type="button"
              onClick={openModal}
              className="sticker sticker-hover rounded-lg bg-purple-600 px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-purple-500"
            >
              Connect Mind
            </button>
        </div>
